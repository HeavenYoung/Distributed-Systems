...
public final class MatrixServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.yangtian.matrix.MatrixService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.yangtian.matrix.MatrixRequest,
      com.yangtian.matrix.MatrixResponse> METHOD_MULTIPLY_BLOCK =
      io.grpc.MethodDescriptor.<com.yangtian.matrix.MatrixRequest, com.yangtian.matrix.MatrixResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.yangtian.matrix.MatrixService", "multiplyBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yangtian.matrix.MatrixRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yangtian.matrix.MatrixResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.yangtian.matrix.MatrixRequest,
      com.yangtian.matrix.MatrixResponse> METHOD_ADD_BLOCK =
      io.grpc.MethodDescriptor.<com.yangtian.matrix.MatrixRequest, com.yangtian.matrix.MatrixResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.yangtian.matrix.MatrixService", "addBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yangtian.matrix.MatrixRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yangtian.matrix.MatrixResponse.getDefaultInstance()))
  ...
  public static abstract class MatrixServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void multiplyBlock(com.yangtian.matrix.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.yangtian.matrix.MatrixResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_MULTIPLY_BLOCK, responseObserver);
    }

    /**
     */
    public void addBlock(com.yangtian.matrix.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.yangtian.matrix.MatrixResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yangtian.matrix.MatrixRequest,
                com.yangtian.matrix.MatrixResponse>(
  ...
  public static final class MatrixServiceBlockingStub extends io.grpc.stub.AbstractStub<MatrixServiceBlockingStub> {
    ...
    /**
     */
    public com.yangtian.matrix.MatrixResponse multiplyBlock(com.yangtian.matrix.MatrixRequest request) {
    ...
    /**
     */
    public com.yangtian.matrix.MatrixResponse addBlock(com.yangtian.matrix.MatrixRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MatrixServiceFutureStub extends io.grpc.stub.AbstractStub<MatrixServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yangtian.matrix.MatrixResponse> multiplyBlock(
        com.yangtian.matrix.MatrixRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yangtian.matrix.MatrixResponse> addBlock(
        com.yangtian.matrix.MatrixRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MULTIPLY_BLOCK:
          serviceImpl.multiplyBlock((com.yangtian.matrix.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.yangtian.matrix.MatrixResponse>) responseObserver);
          break;
        case METHODID_ADD_BLOCK:
          serviceImpl.addBlock((com.yangtian.matrix.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.yangtian.matrix.MatrixResponse>) responseObserver);
          break;
        default:
  ...
  private static final class MatrixServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yangtian.matrix.MatrixServiceOuterClass.getDescriptor();
    }
  }
